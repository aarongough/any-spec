...
AnySpec expects that you define a small specification file in YAML format defining where your test-cases are and what their file-extension is, for instance:
